...
$msgID = $MESSAGE['GET_WITHDRAW_RECORD'];
...
$record = DB_operator_getUserWithdrawSuccRecord($connObj->redisConn, $uid);
...
$messageRetData->record = (isset($record)&&$record['data'])?$record['data']:[];
