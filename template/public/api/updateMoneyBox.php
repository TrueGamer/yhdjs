...
$msgID = $MESSAGE['UPDATE_MONEY_BOX'];
$uid  = number_format($parameter['uid'],0, '', ''); // uid
$money = (int)$parameter['money'];     // 往存钱罐增加的金钱
...
$addMoney = roleManager_updateMoneyBox($player, $money);
...
$messageRetData->addMoney = $addMoney; // 存钱罐实际增加的金钱
